...
function init(img_left, img_right, delay=100) {
      ...
      container.innerHTML = `
        <div class="img-comp-container" style="height: ${width}px;">
          <div class="img-comp-img">
            <img src="${img_right}" width="${width}" height="${width}">
          </div>
          <div class="img-comp-img img-comp-overlay">
            <img src="${img_left}" width="${width}" height="${width}">
          </div>
        </div>
      `;
      initComparisons();
  ...
  function debounceResize() {
      ...
      resizeTimeout = setTimeout(onResize, delay); // Adjust the timeout as needed
  }
